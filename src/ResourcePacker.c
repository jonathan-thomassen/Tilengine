...
static uint8_t iv[AES_BLOCK_SIZE] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
...
static void aes_decrypt_cbc(const uint8_t *in, size_t in_len, uint8_t *out, const WORD *key,
                            int keysize, const uint8_t *init_vec) {
