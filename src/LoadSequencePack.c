...
static void handle_sequence_attribute(const char *szAttribute, const char *szValue) {
...
static void handle_strip_attribute(const char *szAttribute, const char *szValue) {
