...
void aes_key_setup(
    const uint8_t key[], // The key, must be 128, 192, or 256 bits
...
///////////////////
void increment_iv(
    uint8_t iv[],      // Must be a multiple of AES_BLOCK_SIZE
...
int aes_decrypt_ccm(
    ...
    // for encryption.
    unsigned short nonce_len, // IN  - Nonce length in bytes.
    uint8_t plaintext[], // OUT - The plaintext that was decrypted. Will need to
