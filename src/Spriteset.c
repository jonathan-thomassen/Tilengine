 ...
 *
 * \param info
 * Pointer to application-allocated TLN_SpriteInfo structure that will receive
 * the data
 *
 * \returns
 ...
 *
 * \remarks
 * The palette of a spriteset is created at load time and cannot be modified.
 * When TLN_ConfigSprite function is used to setup a sprite, the palette
 * associated with the specified spriteset is automatically assigned to that
 * sprite, but it can be later replaced with TLN_SetSpritePalette
 *
 * \see
