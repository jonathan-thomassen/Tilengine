...
/*!
 * \brief
 * Modifies a range of colors by adding the provided color value to the selected
 * range. The result is always a brighter color.
 *
 * \param palette
 * Reference to the palette to modify
 *
...
/*!
 * \brief
 * Modifies a range of colors by subtracting the provided color value to the
 * selected range. The result is always a darker color.
 *
 * \param palette
 * Reference to the palette to modify
 *
...
/*!
 * \brief
 * Modifies a range of colors by modulating (normalized product) the provided
 * color value to the selected range. The result is always a darker color.
 *
 * \param palette
 * Reference to the palette to modify
 *
