 ...
 *
 * \param name Optional name used to retrieve it when adding to a
 * TLN_SequencePack, can be NULL
 ...
 * \remarks Trailing numbers in sprite names must start with 1 and be
 * correlative (eg basename1... basename14)
 */
 ...
 *
 * \param info
 * Pointer to a user-provided TLN_SequenceInfo structure to hold the returned
 * data
 *
 * \see
 * TLN_FindSequence()
