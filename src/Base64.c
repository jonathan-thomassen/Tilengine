...
static const unsigned char d[] = {
    66, 66, 66, 66, 66, 66, 66, 66, 66, 64, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66,
...
static int accumulate(unsigned char c, int *buf, unsigned char **out, int *len, int outLen) {
    *buf = *buf << 6 | c;
    if (!(*buf & 0x1000000)) {
        return 0;
    }
