...
RGB sky[] = {{0x66, 0x22, 0xEE}, {0xCC, 0xCC, 0xEE}};

static void InterpolateColor(int v, int v1, int v2, RGB const *color1,
                             RGB const *color2, RGB *result);

/* layers */
enum { LAYER_PLAYFIELD, MAX_LAYER };
