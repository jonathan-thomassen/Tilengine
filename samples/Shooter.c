...
int main(int argc, char *argv[]) {
  ...
  sequences[SEQ_CLAW] =
      TLN_CreateSpriteSequence(NULL, spritesets[SPRITESET_MAIN], "claw", 4);
  sequences[SEQ_BLADE1] =
      TLN_CreateSpriteSequence(NULL, spritesets[SPRITESET_MAIN], "bladeb", 2);
  sequences[SEQ_BLADE2] =
      TLN_CreateSpriteSequence(NULL, spritesets[SPRITESET_MAIN], "blades", 2);
  sequences[SEQ_EXPLO1] =
      TLN_CreateSpriteSequence(NULL, spritesets[SPRITESET_MAIN], "explb", 3);
  sequences[SEQ_EXPLO2] =
      TLN_CreateSpriteSequence(NULL, spritesets[SPRITESET_MAIN], "expls", 2);
